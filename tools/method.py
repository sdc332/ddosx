...
class AttackMethod:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        print(f"{Fore.MAGENTA}[!] {Fore.BLUE}Sulmi FILLOJ{Fore.RESET}")
    ...
    def Start(self):
        ...
        print(
            f"{Fore.MAGENTA}[?] {Fore.BLUE}SUDAN {target} Sulmo me DDOS SUDAN  {self.name}.{Fore.RESET}\n"
            f"{Fore.MAGENTA}[?] {Fore.BLUE}SUDAN {Fore.MAGENTA}{duration}{Fore.BLUE}.{Fore.RESET}"
        )
